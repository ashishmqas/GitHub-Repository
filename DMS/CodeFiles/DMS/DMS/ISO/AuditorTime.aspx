            ...
            <div class="formRow">
                ...
                <div class="row">
                    ...
                    <div class="four columns">
                        <asp:TextBox ID="tbAuditPlanning" runat="server" class="input-text ttip_r large" TextMode="Number" ClientIDMode="Static"></asp:TextBox>
                    ...
                    <div class="four columns">
                        <asp:TextBox ID="tbOnsiteAudit" runat="server" class="input-text ttip_r large" TextMode="Number" ClientIDMode="Static"></asp:TextBox>
                    </div>
