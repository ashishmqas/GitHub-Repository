...
<body>
    <form id="form1" runat="server">
        ...
        * Number of employees who are monitoring and controlling management system
        ...
        <br />
        <asp:Repeater ID="rpt_Next" runat="server" OnItemDataBound="rpt_Next_ItemDataBound">
            <HeaderTemplate>
                <table border="0" style="width: 100%; border: solid 1px; border-collapse: collapse;">
                    <thead>
                        <tr>
            ...
            <ItemTemplate>
                <tr>
                    <td style="width: 30%; border-bottom: solid 1px; border-right: solid 1px; text-align: center;"><%#Eval("VAL") %></td>
                    <td style="width: 70%; border-bottom: solid 1px; border-right: solid 1px;">
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="2">
                    <h3 style="color: cadetblue">10.	Change in Organization data (w.r.t Questionnaire or last audit)</h3>
                </td>
            </tr>
        </table>
        <br />
        <table style="width: 100%; border: solid 1px; border-collapse: collapse;">
            <tr>
                <th style="width: 30%; border-bottom: solid 1px; border-right: solid 1px; background-color: #E5E7E9;">Description</th>
                <th style="width: 35%; border-bottom: solid 1px; border-right: solid 1px; background-color: #E5E7E9;">Previous data</th>
                <th style="width: 35%; border-bottom: solid 1px; border-right: solid 1px; background-color: #E5E7E9;">New data</th>
            </tr>
            <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Client Name</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Communication address</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Phone number</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Contact person title (Mr/Ms)</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Contact person First Name</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Contact person Last Name</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Contact Person Designation</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Contact Person Cellphone</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Contact Person email</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Scope</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Number of locations</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
             <tr>
                <td style="border-bottom: solid 1px; border-right: solid 1px;">Addresses of Sites under scope</td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
                <td style="border-bottom: solid 1px; border-right: solid 1px;"></td>
            </tr>
