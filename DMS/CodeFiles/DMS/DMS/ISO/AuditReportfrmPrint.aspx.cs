    ...
    public partial class AuditReportfrmPrint : System.Web.UI.Page
    {
        ...
        private void SetCompany()
        {
            try
            {
                ...
                AuditReportModel ar=new AuditReportModel();
                ar.ProgramId=hfP.Value;
                ar.Condition="ShowAuditNextState";
                DataTable dtAuditStatement = oAuditReportBL.GetNextAuditStatement(ar);
                rpt_Next.DataSource = dtAuditStatement;
                rpt_Next.DataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void rpt_Next_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            try
            {
