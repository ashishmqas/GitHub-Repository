		...
		init: function(){
			...
			//$('.sw_width').click(function(){
				...
				if( $(this).children('img.sw_full').is(':visible') ){
					...
					$('.container > .row').stop().animate({'max-width' : fullW - 40}, 0, function(){
	...
	prth_box_actions = {
		init: function() {
			$('.box_actions').each(function(){
				$(this).append('<span class="bAct_hide"><img src="../img/blank.gi" class="bAct_x" alt="" /></span>');
				$(this).append('<span class="bAct_toggle"><img src="../img/blank.gi" class="bAct_minus" alt="" /></span>');
				...
				$(this).find('.bAct_toggle').on('click', function(){
					if( $(this).closest('.box_c_heading').next('.box_c_content').is(':visible') ) {
						...
						$(this).html('<img src="../img/blank.gi" class="bAct_plus" alt="" />');
					} else {
						$(this).closest('.box_c_heading').next('.box_c_content').slideDown('slow');
						$(this).html('<img src="../img/blank.gi" class="bAct_minus" alt="" />');
					}
				});
			});
		}
...
// ----- Forms ----- //
	...
	prth_mask_input = {
		init: function() {
			...
			$("#mask_phone").inputmask("(__) __-__-______");
			$("#mask_fax").inputmask("###-##-#####");
	...
	prth_calendar = {
		init: function() {
			...
			var calendar = $('#calendar').fullCalendar({
				...
				buttonText: {
					prev: '<img src="../img/blank.gi" alt="" class="table_prev" />',
					next: '<img src="../img/blank.gi" alt="" class="table_next" />'
				},
				aspectRatio: 2,
				selectable: true,
				selectHelper: true,
