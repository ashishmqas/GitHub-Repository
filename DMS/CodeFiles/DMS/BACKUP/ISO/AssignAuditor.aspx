            ...
            <asp:Repeater ID="rpt_list" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="essential" style="width: 10%"><%--<a href="AssignAuditor.aspx?i=<%#Eval("id") %>"><img src="../../img/ico/pencil_gray.png" alt="Edit" /></a>&nbsp;|&nbsp;--%><a href="AssignAuditor.aspx?d=<%#Eval("id") %>&p=<%#Eval("aprogramid") %>"><img src="../../img/ico/trashcan_gray.png" alt="Delete" /></a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </tbody>
