<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Site1.Master" AutoEventWireup="true" CodeBehind="QuotationRequestfrm.aspx.cs" Inherits="DMS.ISO.QuotationRequestfrm" %>
    ...
    <div class="box_c">
        ...
        <div class="box_c_content form_a">
                                ...
                                <div class="inner">
                                    <div class="row">
                                        ...
                                        <div class="four columns">
                                            <asp:TextBox ID="tbCName" runat="server" class="input-text ttip_r large" ClientIDMode="Static"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="four columns">
                                            <asp:TextBox ID="tbStreet" runat="server" class="input-text ttip_r large" ClientIDMode="Static"></asp:TextBox>
                                        </div>
                                        <div class="two columns">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="two columns"> <label for="fname_a">Sponsor</label></div>
                                        <div class="four columns"><asp:TextBox ID="tbSponsor" runat="server" class="input-text ttip_r large" ClientIDMode="Static"></asp:TextBox></div>
                                    </div>
                                    <div class="row">
            ...
            <div class="formRow">
                <div class="row">
                    <div class="four columns">
                        <asp:TextBox ID="tbDate" runat="server" class="input-text ttip_r max large" ClientIDMode="Static" placeholder="dd/mm/yyyy"></asp:TextBox></div>
                    <div class="four columns">
                        <asp:TextBox ID="tbPlace" runat="server" class="input-text ttip_r max large" ClientIDMode="Static" placeholder="Place"></asp:TextBox></div>
                    <div class="four columns">
                        <asp:TextBox ID="tbName" runat="server" class="input-text ttip_r max large" ClientIDMode="Static" placeholder="Person Name"></asp:TextBox></div>
                </div>
            </div>
